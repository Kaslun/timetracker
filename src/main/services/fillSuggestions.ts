...
const SEED: Omit<FillSuggestion, "id">[] = [
  {
    at: "10:45",
    src: "Teams",
    label: "Design sync — tracker v2",
    meta: "55 min · recurring",
    confidence: 0.92,
    picked: true,
    durationMinutes: 55,
    taskId: "tsk_dsync",
  },
  {
    at: "12:10",
    src: "Slack",
    label: "Threaded reply · #eng-platform",
    meta: "14 messages",
    confidence: 0.71,
    picked: true,
    durationMinutes: 14,
  ...
  },
  {
    at: "13:02",
    src: "Linear",
    label: "ATT-412 · moved to In Review",
    meta: "you · 2m",
    confidence: 0.85,
    picked: false,
    durationMinutes: 2,
  ...
  },
  {
    at: "13:40",
    src: "VS Code",
    label: "mobile-runtime/branching.ts",
    meta: "42 min active",
    confidence: 0.88,
    picked: true,
    durationMinutes: 42,
