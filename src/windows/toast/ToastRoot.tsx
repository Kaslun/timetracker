import { toastKind } from '@/shared/api';
...
export function ToastRoot() {
  ...
  switch (kind) {
    case 'idle_recover': return <IdleRecoveryToast />;
    case 'retro_fill':   return <RetroFillToast />;
    case 'slack':        return <SlackToast />;
    case 'teams':        return <TeamsToast />;
    default:             return null;
  }
}
